...
.method private final migration_NotConnected(I)V
    ...
    invoke-virtual {v3, v4}, Lage/of/civilizations2/jakowski/lukasz/Civilization;->migratesFromProvinceID(I)Z
    ...
    check-cast v6, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy_Migrate;
    ...
    check-cast v3, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy_Migrate;

    invoke-virtual {v3, v1}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy_Migrate;->getRoute(I)I

    move-result v3

    invoke-virtual {v0, v2, v3, p1, v1}, Lage/of/civilizations2/jakowski/lukasz/GameAction;->migrateToProvince(IIIZ)Z
    :try_end_0
...
.method private final migration_NotConnected_OLD(I)V
    ...
    invoke-virtual {v3, v4, v5, p1, v1}, Lage/of/civilizations2/jakowski/lukasz/GameAction;->migrateToProvince(IIIZ)Z
...
.method public buildStartingBuildings(I)V
    ...
    invoke-virtual {p1, v1}, Lage/of/civilizations2/jakowski/lukasz/Province;->setLvlOfFarm(I)V
    :try_end_0
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final migration(I)Z
    ...
    invoke-virtual {v4, v5, v6, p1, v1}, Lage/of/civilizations2/jakowski/lukasz/GameAction;->migrateToProvince(IIIZ)Z
    ...
    invoke-static {v0, p1}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->uncivilizedCanMigrate_FromProv(II)Z
    ...
    invoke-static {v4, p1}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->uncivilizedCanMigrate(II)Z
    ...
    invoke-direct {p0, v5, p1}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Playstyle/AI_Playstyle_Tribal;->migrationTo_Score(II)I
    ...
    invoke-direct {p0, v6, p1}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Playstyle/AI_Playstyle_Tribal;->migrationTo_Score(II)I
    ...
    invoke-virtual {v3, v5, v0, p1, v1}, Lage/of/civilizations2/jakowski/lukasz/GameAction;->migrateToProvince(IIIZ)Z
    ...
    invoke-virtual {v0, v3, v4, p1, v1}, Lage/of/civilizations2/jakowski/lukasz/GameAction;->migrateToProvince(IIIZ)Z
    :try_end_0
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_0 .. :try_end_0} :catch_0
