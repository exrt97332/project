...
.method public getProvinceInformation()Lage/of/civilizations2/jakowski/lukasz/MenuE_HoverP/ME_Hover;
    ...
    sget-object v5, Lage/of/civilizations2/jakowski/lukasz/Messages/Alliance/Become/iq/GBACejVA;->oVYnXQbDZvM:Ljava/lang/String;
...
.method public updateActiveProvinceID_ExtraAction(II)V
    ...
    .line 4029
    sget-boolean v1, Lage/of/civilizations2/jakowski/lukasz/Menus/Turn/Menu_NextPlayerTurn;->lockExtraAction:Z

    const/4 v2, 0x1

    if-nez v1, :cond_2

    sget-boolean v1, Lage/of/civilizations2/jakowski/lukasz/MapA/BuildingsManager;->buildBySelectingProvinceOnMap:Z
    ...
    invoke-static {p2, v1}, Lage/of/civilizations2/jakowski/lukasz/GameManager;->invest_MaxEconomy_Gold(II)I
    ...
    invoke-static {p2, v3, v1}, Lage/of/civilizations2/jakowski/lukasz/GameManager;->invest(III)Z
    ...
    iput-boolean v2, p2, Lage/of/civilizations2/jakowski/lukasz/Province;->viewBool:Z

    .line 4041
    sget-object p2, Lage/of/civilizations2/jakowski/lukasz/CFG;->menus:Lage/of/civilizations2/jakowski/lukasz/MenuManager;

    invoke-virtual {p2}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->getVisible_InGame_View_Stats()Z
    ...
    invoke-virtual {p2, v2}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->setVisible_InGame_ViewEconomy(Z)V

    .line 4046
    :cond_0
    sget-object p2, Lage/of/civilizations2/jakowski/lukasz/CFG;->SFXManager:Lage/of/civilizations2/jakowski/lukasz/SFXManager;

    sget v1, Lage/of/civilizations2/jakowski/lukasz/SFXManager;->SFX_WORKSHOP:I

    invoke-virtual {p2, v1}, Lage/of/civilizations2/jakowski/lukasz/SFXManager;->playSound(I)V
    ...
    invoke-virtual {v1, p2, v3}, Lage/of/civilizations2/jakowski/lukasz/Toast;->addM(Ljava/lang/String;Lcom/badlogic/gdx/graphics/Color;)V
    ...
    invoke-virtual {p2, v1}, Lage/of/civilizations2/jakowski/lukasz/Toast;->setTimeInView(I)V
    ...
    invoke-virtual {p1, v2}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->setVisible_InGame_ViewEconomy(Z)V
