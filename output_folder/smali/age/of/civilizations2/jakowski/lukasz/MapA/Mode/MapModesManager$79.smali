...
.method public drawProvinces(Lcom/badlogic/gdx/graphics/g2d/SpriteBatch;)V
    ...
    invoke-virtual {v1, v4}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->getPIV(I)I
    ...
    invoke-direct {v0, v1, v6, v7, v8}, Lcom/badlogic/gdx/graphics/Color;-><init>(FFFF)V
    ...
    sget-wide v8, Lage/of/civilizations2/jakowski/lukasz/RenderProvince;->PROVINCE_COLOR_ANIMATION_TIMER:J
    ...
    sget v7, Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapModesManager;->POPULATION_OF_CIVID:I
    ...
    invoke-virtual {v6, p1}, Lage/of/civilizations2/jakowski/lukasz/Province;->drawLandProv(Lcom/badlogic/gdx/graphics/g2d/SpriteBatch;)V
