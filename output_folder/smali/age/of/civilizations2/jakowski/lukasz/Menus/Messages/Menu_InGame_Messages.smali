...
.field public static ANIMATION_TIMER:J = 0xe1L

.field public static IN_ANIMATION:Z = false

.field public static START_ANIMATION:Z = false

.field public static VIEW_BEFORE:I = -0x1
...
.method public constructor <init>()V
    ...
    sget-object v3, Lage/of/civilizations2/jakowski/lukasz/Messages/MessageType;->PEACE_TREATY_LIST_OF_DEMANDS:Lage/of/civilizations2/jakowski/lukasz/Messages/MessageType;
    ...
    invoke-virtual {v3, v1}, Lage/of/civilizations2/jakowski/lukasz/Messages/MessageBox_GameData;->getMessage(I)Lage/of/civilizations2/jakowski/lukasz/Messages/Message;

    move-result-object v3

    iget-object v3, v3, Lage/of/civilizations2/jakowski/lukasz/Messages/Message;->TAG:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->getPeaceTreaty_GameDataID(Ljava/lang/String;)I
    ...
    invoke-virtual {v2, v1}, Lage/of/civilizations2/jakowski/lukasz/Messages/MessageBox_GameData;->removeMessage(I)V
    ...
    .line 49
    new-instance v2, Lage/of/civilizations2/jakowski/lukasz/Button/Button_Message;
    ...
    iget v12, v3, Lage/of/civilizations2/jakowski/lukasz/Messages/Message;->fromCivID:I
    ...
    invoke-virtual {v3}, Lage/of/civilizations2/jakowski/lukasz/Messages/Message;->getImageID()I
    ...
    invoke-virtual {v3}, Lage/of/civilizations2/jakowski/lukasz/Messages/Message;->getBGImageID()I
    ...
    invoke-direct/range {v8 .. v14}, Lage/of/civilizations2/jakowski/lukasz/Button/Button_Message;-><init>(IIIIII)V
...
.method public final actionEL(I)V
    ...
    invoke-virtual {v0, v1}, Lage/of/civilizations2/jakowski/lukasz/Messages/Message;->onAction(I)V
...
.method public drawMenuElements(Lcom/badlogic/gdx/graphics/g2d/SpriteBatch;IIZ)V
    ...
    .line 99
    :goto_0
    iget v1, p0, Lage/of/civilizations2/jakowski/lukasz/Menus/Messages/Menu_InGame_Messages;->iMenuElemsSize:I

    if-ge v0, v1, :cond_2

    .line 100
    iget-object v1, p0, Lage/of/civilizations2/jakowski/lukasz/Menus/Messages/Menu_InGame_Messages;->menuElem:Ljava/util/List;
    ...
    .line 103
    sget-wide v1, Lage/of/civilizations2/jakowski/lukasz/Menus/Messages/Menu_InGame_Messages;->ANIMATION_TIMER:J

    long-to-double v1, v1

    iget v3, p0, Lage/of/civilizations2/jakowski/lukasz/Menus/Messages/Menu_InGame_Messages;->ANIMATION_GROWTH_LIMIT:F

    float-to-double v3, v3

    iget v5, p0, Lage/of/civilizations2/jakowski/lukasz/Menus/Messages/Menu_InGame_Messages;->ANIMATION_GROWTH:F
    ...
    sget-wide v5, Lage/of/civilizations2/jakowski/lukasz/Menus/Messages/Menu_InGame_Messages;->ANIMATION_TIME:J
    ...
    :goto_1
    :try_start_0
    iget-object v2, p0, Lage/of/civilizations2/jakowski/lukasz/Menus/Messages/Menu_InGame_Messages;->menuElem:Ljava/util/List;
    ...
    .line 118
    invoke-virtual {p0, p4, v0}, Lage/of/civilizations2/jakowski/lukasz/Menus/Messages/Menu_InGame_Messages;->getMenuElementIsActive(ZI)Z

    move-result v7

    iget-boolean v8, p0, Lage/of/civilizations2/jakowski/lukasz/Menus/Messages/Menu_InGame_Messages;->scrollableY:Z

    move-object v4, p1

    .line 114
    invoke-virtual/range {v3 .. v8}, Lage/of/civilizations2/jakowski/lukasz/Button/MenuElemUI;->drawE(Lcom/badlogic/gdx/graphics/g2d/SpriteBatch;IIZZ)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
