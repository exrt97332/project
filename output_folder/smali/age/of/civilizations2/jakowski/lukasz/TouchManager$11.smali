...
.method public extraAction(II)V
    ...
    .line 1365
    sget-boolean p1, Lage/of/civilizations2/jakowski/lukasz/CFG;->SPECTATOR_MODE_DIPLOMACY_ACTIONS_MODE:Z
    ...
    invoke-virtual {p2, v0}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->getPlayer(I)Lage/of/civilizations2/jakowski/lukasz/Player;
    ...
    invoke-virtual {p2, v0}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->disableDrawCivilizationRegions(I)V
    ...
    sget p2, Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapModesManager;->VIEW_DIPLOMACY_MODE:I
    ...
    invoke-virtual {p1, p2, v3}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->enableDrawCivilizationRegions_FogOfWar(II)V
    ...
    invoke-virtual {p1, p2, v3}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->enableDrawCivilizationRegions(II)V
    ...
    invoke-virtual {p2, v1}, Lage/of/civilizations2/jakowski/lukasz/LangManager;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    sput-boolean v2, Lage/of/civilizations2/jakowski/lukasz/CFG;->SPECTATOR_MODE_DIPLOMACY_ACTIONS_MODE:Z

    return-void

    .line 1392
    :cond_3
    sget p1, Lage/of/civilizations2/jakowski/lukasz/CFG;->SPECTATOR_MODE_DECLARE_WAR_MODE:I
    ...
    invoke-virtual {p1, p2}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->rebuildInGame_DeclareWar(I)V
    ...
    invoke-virtual {p1, p2}, Lage/of/civilizations2/jakowski/lukasz/Player;->setCivId(I)V
    ...
    invoke-virtual {p1}, Lage/of/civilizations2/jakowski/lukasz/Player;->loadPlayersFlag()V
    ...
    invoke-virtual {p1, p2}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->updateInGameTopAll(I)V
    ...
    invoke-virtual {p1, v3}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->setVisible_InGame_Budget(Z)V
    ...
    invoke-virtual {p1}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->getVisible_InGame_FlagAction_Console()Z
    ...
    invoke-virtual {p1, v3}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->setVisible_InGame_FlagAction(Z)V
    ...
    sget p2, Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapModesManager;->VIEW_INCOME_MODE:I
    ...
    invoke-virtual {p1, v3}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->setVisible_InGame_ViewIncome(Z)V
    ...
    invoke-virtual {p1, v2}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->autoBuildChooseProvinceMode(Z)V
    ...
    invoke-virtual {v0, p1}, Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapMode;->updateActiveCivInfo_ExtraAction(I)V
    ...
    invoke-virtual {p1}, Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapModesManager;->getActiveView()Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapMode;

    move-result-object p1

    invoke-virtual {p1}, Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapMode;->setActiveProvinceAction()V
    ...
    .line 1459
    invoke-static {p2}, Lage/of/civilizations2/jakowski/lukasz/RTS;->updateTimePast_AfterAction(F)V
    ...
    .line 1467
    sget p1, Lage/of/civilizations2/jakowski/lukasz/CFG;->OUDH:I
    ...
    .line 1469
    sget-object p1, Lage/of/civilizations2/jakowski/lukasz/CFG;->LPHE:Ljava/util/List;
    ...
    .line 1470
    sget-object p2, Lage/of/civilizations2/jakowski/lukasz/CFG;->LPHE:Ljava/util/List;
    ...
    invoke-static {p2, v1, v2}, Lage/of/civilizations2/jakowski/lukasz/CFG;->mvTFL(III)V
    ...
    .line 1477
    :cond_f
    sput v0, Lage/of/civilizations2/jakowski/lukasz/CFG;->OUDH:I
